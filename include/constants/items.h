...
// Loot Eggs!
#define ITEM_EGG_START 349
#define ITEM_EGG_PLAIN_NORMAL (ITEM_EGG_START + TYPE_NORMAL * 4 + 0)
#define ITEM_EGG_PLAIN_GREAT (ITEM_EGG_START + TYPE_NORMAL * 4 + 1)
#define ITEM_EGG_PLAIN_ULTRA (ITEM_EGG_START + TYPE_NORMAL * 4 + 2)
#define ITEM_EGG_PLAIN_MASTER (ITEM_EGG_START + TYPE_NORMAL * 4 + 3)
#define ITEM_EGG_BLAZING_NORMAL (ITEM_EGG_START + TYPE_FIRE * 4 + 0)
#define ITEM_EGG_BLAZING_GREAT (ITEM_EGG_START + TYPE_FIRE * 4 + 1)
#define ITEM_EGG_BLAZING_ULTRA (ITEM_EGG_START + TYPE_FIRE * 4 + 2)
#define ITEM_EGG_BLAZING_MASTER (ITEM_EGG_START + TYPE_FIRE * 4 + 3)
#define ITEM_EGG_PUNCHY_NORMAL (ITEM_EGG_START + TYPE_FIGHTING * 4 + 0)
#define ITEM_EGG_PUNCHY_GREAT (ITEM_EGG_START + TYPE_FIGHTING * 4 + 1)
#define ITEM_EGG_PUNCHY_ULTRA (ITEM_EGG_START + TYPE_FIGHTING * 4 + 2)
#define ITEM_EGG_PUNCHY_MASTER (ITEM_EGG_START + TYPE_FIGHTING * 4 + 3)
#define ITEM_EGG_MOIST_NORMAL (ITEM_EGG_START + TYPE_WATER * 4 + 0)
#define ITEM_EGG_MOIST_GREAT (ITEM_EGG_START + TYPE_WATER * 4 + 1)
#define ITEM_EGG_MOIST_ULTRA (ITEM_EGG_START + TYPE_WATER * 4 + 2)
#define ITEM_EGG_MOIST_MASTER (ITEM_EGG_START + TYPE_WATER * 4 + 3)
#define ITEM_EGG_LOFTY_NORMAL (ITEM_EGG_START + TYPE_FLYING * 4 + 0)
#define ITEM_EGG_LOFTY_GREAT (ITEM_EGG_START + TYPE_FLYING * 4 + 1)
#define ITEM_EGG_LOFTY_ULTRA (ITEM_EGG_START + TYPE_FLYING * 4 + 2)
#define ITEM_EGG_LOFTY_MASTER (ITEM_EGG_START + TYPE_FLYING * 4 + 3)
#define ITEM_EGG_LEAFY_NORMAL (ITEM_EGG_START + TYPE_GRASS * 4 + 0)
#define ITEM_EGG_LEAFY_GREAT (ITEM_EGG_START + TYPE_GRASS * 4 + 1)
#define ITEM_EGG_LEAFY_ULTRA (ITEM_EGG_START + TYPE_GRASS * 4 + 2)
#define ITEM_EGG_LEAFY_MASTER (ITEM_EGG_START + TYPE_GRASS * 4 + 3)
#define ITEM_EGG_SICKLY_NORMAL (ITEM_EGG_START + TYPE_POISON * 4 + 0)
#define ITEM_EGG_SICKLY_GREAT (ITEM_EGG_START + TYPE_POISON * 4 + 1)
#define ITEM_EGG_SICKLY_ULTRA (ITEM_EGG_START + TYPE_POISON * 4 + 2)
#define ITEM_EGG_SICKLY_MASTER (ITEM_EGG_START + TYPE_POISON * 4 + 3)
#define ITEM_EGG_CHARGED_NORMAL (ITEM_EGG_START + TYPE_ELECTRIC * 4 + 0)
#define ITEM_EGG_CHARGED_GREAT (ITEM_EGG_START + TYPE_ELECTRIC * 4 + 1)
#define ITEM_EGG_CHARGED_ULTRA (ITEM_EGG_START + TYPE_ELECTRIC * 4 + 2)
#define ITEM_EGG_CHARGED_MASTER (ITEM_EGG_START + TYPE_ELECTRIC * 4 + 3)
#define ITEM_EGG_DIRTY_NORMAL (ITEM_EGG_START + TYPE_GROUND * 4 + 0)
#define ITEM_EGG_DIRTY_GREAT (ITEM_EGG_START + TYPE_GROUND * 4 + 1)
#define ITEM_EGG_DIRTY_ULTRA (ITEM_EGG_START + TYPE_GROUND * 4 + 2)
#define ITEM_EGG_DIRTY_MASTER (ITEM_EGG_START + TYPE_GROUND * 4 + 3)
#define ITEM_EGG_PSIONIC_NORMAL (ITEM_EGG_START + TYPE_PSYCHIC * 4 + 0)
#define ITEM_EGG_PSIONIC_GREAT (ITEM_EGG_START + TYPE_PSYCHIC * 4 + 1)
#define ITEM_EGG_PSIONIC_ULTRA (ITEM_EGG_START + TYPE_PSYCHIC * 4 + 2)
#define ITEM_EGG_PSIONIC_MASTER (ITEM_EGG_START + TYPE_PSYCHIC * 4 + 3)
#define ITEM_EGG_STURDY_NORMAL (ITEM_EGG_START + TYPE_ROCK * 4 + 0)
#define ITEM_EGG_STURDY_GREAT (ITEM_EGG_START + TYPE_ROCK * 4 + 1)
#define ITEM_EGG_STURDY_ULTRA (ITEM_EGG_START + TYPE_ROCK * 4 + 2)
#define ITEM_EGG_STURDY_MASTER (ITEM_EGG_START + TYPE_ROCK * 4 + 3)
#define ITEM_EGG_CHILLY_NORMAL (ITEM_EGG_START + TYPE_ICE * 4 + 0)
#define ITEM_EGG_CHILLY_GREAT (ITEM_EGG_START + TYPE_ICE * 4 + 1)
#define ITEM_EGG_CHILLY_ULTRA (ITEM_EGG_START + TYPE_ICE * 4 + 2)
#define ITEM_EGG_CHILLY_MASTER (ITEM_EGG_START + TYPE_ICE * 4 + 3)
#define ITEM_EGG_WRIGGLY_NORMAL (ITEM_EGG_START + TYPE_BUG * 4 + 0)
#define ITEM_EGG_WRIGGLY_GREAT (ITEM_EGG_START + TYPE_BUG * 4 + 1)
#define ITEM_EGG_WRIGGLY_ULTRA (ITEM_EGG_START + TYPE_BUG * 4 + 2)
#define ITEM_EGG_WRIGGLY_MASTER (ITEM_EGG_START + TYPE_BUG * 4 + 3)
#define ITEM_EGG_NOBLE_NORMAL (ITEM_EGG_START + TYPE_DRAGON * 4 + 0)
#define ITEM_EGG_NOBLE_GREAT (ITEM_EGG_START + TYPE_DRAGON * 4 + 1)
#define ITEM_EGG_NOBLE_ULTRA (ITEM_EGG_START + TYPE_DRAGON * 4 + 2)
#define ITEM_EGG_NOBLE_MASTER (ITEM_EGG_START + TYPE_DRAGON * 4 + 3)
#define ITEM_EGG_SPOOKY_NORMAL (ITEM_EGG_START + TYPE_GHOST * 4 + 0)
#define ITEM_EGG_SPOOKY_GREAT (ITEM_EGG_START + TYPE_GHOST * 4 + 1)
#define ITEM_EGG_SPOOKY_ULTRA (ITEM_EGG_START + TYPE_GHOST * 4 + 2)
#define ITEM_EGG_SPOOKY_MASTER (ITEM_EGG_START + TYPE_GHOST * 4 + 3)
#define ITEM_EGG_METALLIC_NORMAL (ITEM_EGG_START + TYPE_STEEL * 4 + 0)
#define ITEM_EGG_METALLIC_GREAT (ITEM_EGG_START + TYPE_STEEL * 4 + 1)
#define ITEM_EGG_METALLIC_ULTRA (ITEM_EGG_START + TYPE_STEEL * 4 + 2)
#define ITEM_EGG_METALLIC_MASTER (ITEM_EGG_START + TYPE_STEEL * 4 + 3)
#define ITEM_EGG_RAINBOW_NORMAL (ITEM_EGG_START + TYPE_MYSTERY * 4 + 0)
#define ITEM_EGG_RAINBOW_GREAT (ITEM_EGG_START + TYPE_MYSTERY * 4 + 1)
#define ITEM_EGG_RAINBOW_ULTRA (ITEM_EGG_START + TYPE_MYSTERY * 4 + 2)
#define ITEM_EGG_RAINBOW_MASTER (ITEM_EGG_START + TYPE_MYSTERY * 4 + 3)
#define ITEM_EGG_SHADY_NORMAL (ITEM_EGG_START + TYPE_DARK * 4 + 0)
#define ITEM_EGG_SHADY_GREAT (ITEM_EGG_START + TYPE_DARK * 4 + 1)
#define ITEM_EGG_SHADY_ULTRA (ITEM_EGG_START + TYPE_DARK * 4 + 2)
#define ITEM_EGG_SHADY_MASTER (ITEM_EGG_START + TYPE_DARK * 4 + 3)
