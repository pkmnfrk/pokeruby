...
#define ITEM_EGG(type, rank) (ITEM_EGG_START + TYPE_##type * 4 + rank)

#define ITEM_EGG_PLAIN_NORMAL    ITEM_EGG(NORMAL,   0)
#define ITEM_EGG_PLAIN_GREAT     ITEM_EGG(NORMAL,   1)
#define ITEM_EGG_PLAIN_ULTRA     ITEM_EGG(NORMAL,   2)
#define ITEM_EGG_PLAIN_MASTER    ITEM_EGG(NORMAL,   3)
#define ITEM_EGG_BLAZING_NORMAL  ITEM_EGG(FIRE,     0)
#define ITEM_EGG_BLAZING_GREAT   ITEM_EGG(FIRE,     1)
#define ITEM_EGG_BLAZING_ULTRA   ITEM_EGG(FIRE,     2)
#define ITEM_EGG_BLAZING_MASTER  ITEM_EGG(FIRE,     3)
#define ITEM_EGG_PUNCHY_NORMAL   ITEM_EGG(FIGHTING, 0)
#define ITEM_EGG_PUNCHY_GREAT    ITEM_EGG(FIGHTING, 1)
#define ITEM_EGG_PUNCHY_ULTRA    ITEM_EGG(FIGHTING, 2)
#define ITEM_EGG_PUNCHY_MASTER   ITEM_EGG(FIGHTING, 3)
#define ITEM_EGG_MOIST_NORMAL    ITEM_EGG(WATER,    0)
#define ITEM_EGG_MOIST_GREAT     ITEM_EGG(WATER,    1)
#define ITEM_EGG_MOIST_ULTRA     ITEM_EGG(WATER,    2)
#define ITEM_EGG_MOIST_MASTER    ITEM_EGG(WATER,    3)
#define ITEM_EGG_LOFTY_NORMAL    ITEM_EGG(FLYING,   0)
#define ITEM_EGG_LOFTY_GREAT     ITEM_EGG(FLYING,   1)
#define ITEM_EGG_LOFTY_ULTRA     ITEM_EGG(FLYING,   2)
#define ITEM_EGG_LOFTY_MASTER    ITEM_EGG(FLYING,   3)
#define ITEM_EGG_LEAFY_NORMAL    ITEM_EGG(GRASS,    0)
#define ITEM_EGG_LEAFY_GREAT     ITEM_EGG(GRASS,    1)
#define ITEM_EGG_LEAFY_ULTRA     ITEM_EGG(GRASS,    2)
#define ITEM_EGG_LEAFY_MASTER    ITEM_EGG(GRASS,    3)
#define ITEM_EGG_SICKLY_NORMAL   ITEM_EGG(POISON,   0)
#define ITEM_EGG_SICKLY_GREAT    ITEM_EGG(POISON,   1)
#define ITEM_EGG_SICKLY_ULTRA    ITEM_EGG(POISON,   2)
#define ITEM_EGG_SICKLY_MASTER   ITEM_EGG(POISON,   3)
#define ITEM_EGG_CHARGED_NORMAL  ITEM_EGG(ELECTRIC, 0)
#define ITEM_EGG_CHARGED_GREAT   ITEM_EGG(ELECTRIC, 1)
#define ITEM_EGG_CHARGED_ULTRA   ITEM_EGG(ELECTRIC, 2)
#define ITEM_EGG_CHARGED_MASTER  ITEM_EGG(ELECTRIC, 3)
#define ITEM_EGG_DIRTY_NORMAL    ITEM_EGG(GROUND,   0)
#define ITEM_EGG_DIRTY_GREAT     ITEM_EGG(GROUND,   1)
#define ITEM_EGG_DIRTY_ULTRA     ITEM_EGG(GROUND,   2)
#define ITEM_EGG_DIRTY_MASTER    ITEM_EGG(GROUND,   3)
#define ITEM_EGG_PSIONIC_NORMAL  ITEM_EGG(PSYCHIC,  0)
#define ITEM_EGG_PSIONIC_GREAT   ITEM_EGG(PSYCHIC,  1)
#define ITEM_EGG_PSIONIC_ULTRA   ITEM_EGG(PSYCHIC,  2)
#define ITEM_EGG_PSIONIC_MASTER  ITEM_EGG(PSYCHIC,  3)
#define ITEM_EGG_STURDY_NORMAL   ITEM_EGG(ROCK,     0)
#define ITEM_EGG_STURDY_GREAT    ITEM_EGG(ROCK,     1)
#define ITEM_EGG_STURDY_ULTRA    ITEM_EGG(ROCK,     2)
#define ITEM_EGG_STURDY_MASTER   ITEM_EGG(ROCK,     3)
#define ITEM_EGG_CHILLY_NORMAL   ITEM_EGG(ICE,      0)
#define ITEM_EGG_CHILLY_GREAT    ITEM_EGG(ICE,      1)
#define ITEM_EGG_CHILLY_ULTRA    ITEM_EGG(ICE,      2)
#define ITEM_EGG_CHILLY_MASTER   ITEM_EGG(ICE,      3)
#define ITEM_EGG_WRIGGLY_NORMAL  ITEM_EGG(BUG,      0)
#define ITEM_EGG_WRIGGLY_GREAT   ITEM_EGG(BUG,      1)
#define ITEM_EGG_WRIGGLY_ULTRA   ITEM_EGG(BUG,      2)
#define ITEM_EGG_WRIGGLY_MASTER  ITEM_EGG(BUG,      3)
#define ITEM_EGG_NOBLE_NORMAL    ITEM_EGG(DRAGON,   0)
#define ITEM_EGG_NOBLE_GREAT     ITEM_EGG(DRAGON,   1)
#define ITEM_EGG_NOBLE_ULTRA     ITEM_EGG(DRAGON,   2)
#define ITEM_EGG_NOBLE_MASTER    ITEM_EGG(DRAGON,   3)
#define ITEM_EGG_SPOOKY_NORMAL   ITEM_EGG(GHOST,    0)
#define ITEM_EGG_SPOOKY_GREAT    ITEM_EGG(GHOST,    1)
#define ITEM_EGG_SPOOKY_ULTRA    ITEM_EGG(GHOST,    2)
#define ITEM_EGG_SPOOKY_MASTER   ITEM_EGG(GHOST,    3)
#define ITEM_EGG_METALLIC_NORMAL ITEM_EGG(STEEL,    0)
#define ITEM_EGG_METALLIC_GREAT  ITEM_EGG(STEEL,    1)
#define ITEM_EGG_METALLIC_ULTRA  ITEM_EGG(STEEL,    2)
#define ITEM_EGG_METALLIC_MASTER ITEM_EGG(STEEL,    3)
#define ITEM_EGG_RAINBOW_NORMAL  ITEM_EGG(MYSTERY,  0)
#define ITEM_EGG_RAINBOW_GREAT   ITEM_EGG(MYSTERY,  1)
#define ITEM_EGG_RAINBOW_ULTRA   ITEM_EGG(MYSTERY,  2)
#define ITEM_EGG_RAINBOW_MASTER  ITEM_EGG(MYSTERY,  3)
#define ITEM_EGG_SHADY_NORMAL    ITEM_EGG(DARK,     0)
#define ITEM_EGG_SHADY_GREAT     ITEM_EGG(DARK,     1)
#define ITEM_EGG_SHADY_ULTRA     ITEM_EGG(DARK,     2)
#define ITEM_EGG_SHADY_MASTER    ITEM_EGG(DARK,     3)
#define NUM_LOOT_EGGS            (ITEM_EGG_SHADY_MASTER - ITEM_EGG_START)
